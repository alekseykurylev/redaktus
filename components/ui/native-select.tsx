...
function NativeSelectRoot({ className, size = 'default', ...props }: NativeSelectProps) {
  return (
    <div
      className={cx(
...
function NativeSelectOptGroup({ className, ...props }: React.ComponentProps<'optgroup'>) {
  return <optgroup data-slot="native-select-optgroup" className={cx(className)} {...props} />
}
NativeSelectOptGroup.displayName = 'NativeSelect.OptGroup'

export { NativeSelectRoot as Root, NativeSelectOptGroup as OptGroup, NativeSelectOption as Option }
